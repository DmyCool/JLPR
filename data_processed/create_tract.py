...
from util.fun_other import *
import geopandas as gpd

def create_tract():
    '''output: chicago shapefile, sorted chicago tractid '''
    chicago = gpd.read_file('../data/Census-Tracts-2010/chicago-tract.shp')
    tractid_list = list(set(chicago['geoid10']))
...
def flow_similarity():
    ...
    flow_similarity_matrix = cosine_similarity(flow_mtx)
    flow_count_similarity_matrix = cosine_similarity(flow_count_mtx)
